...
<html lang="en">
  ...
  <body>
    <h2 class="text-center mt-2">Tambah Makanan Tradisional</h2>
    ...
    <form action="/tambah" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('jenis_makanan') is-invalid @enderror" id="jenis_makanan" name="jenis_makanan">
                @error('jenis_makanan')
